...
HD_PWD='Z:/Vivado Projects/hw_debug/hw_debug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_led_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flow_led_top.tcl
