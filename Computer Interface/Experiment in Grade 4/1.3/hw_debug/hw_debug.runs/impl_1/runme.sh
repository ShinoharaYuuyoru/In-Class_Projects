...
HD_PWD='Z:/Vivado Projects/hw_debug/hw_debug.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flow_led_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flow_led_top.tcl -notrace
