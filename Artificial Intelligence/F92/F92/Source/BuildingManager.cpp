...
BWAPI::TilePosition BuildingManager::getBuildingLocation(const Building & b)
{
    ...
    if (b.isGasSteal)
    {
        ...
        F92_ASSERT(enemyBaseLocation,"Should have enemy base location before attempting gas steal");
        F92_ASSERT(enemyBaseLocation->getGeysers().size() > 0,"Should have spotted an enemy geyser");
