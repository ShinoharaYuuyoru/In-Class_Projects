...
const BuildOrder & StrategyManager::getOpeningBookBuildOrder() const
{
    ...
    {
        F92_ASSERT_WARNING(false, "Strategy not found: %s, returning empty initial build order", Config::Strategy::StrategyName.c_str());
...
const MetaPairVector StrategyManager::getProtossBuildOrderGoal() const
{
    ...
    {
        F92_ASSERT_WARNING(false, "Unknown Protoss Strategy Name: %s", Config::Strategy::StrategyName.c_str());
    }
