...
namespace Config
{
    namespace ConfigFile
    {
        ...
        std::string ConfigFileLocation      = "bwapi-data/AI/F92_Config.txt";
    }
    ...
    namespace Modules							    
    {
        ...
        bool UsingGameCommander             = true;     // toggle GameCommander, effectively F92
    ...
    namespace Debug								
    {
        ...
        std::string ErrorLogFilename        = "F92_ErrorLog.txt";
