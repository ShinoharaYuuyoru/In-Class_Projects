...
void WorkerData::drawDepotDebugInfo()
{
	for (auto & depot : depots)
	{
        ...
        for (auto & mineral : minerals)
        {
            ...
            {
                 //if (Config::Debug::DRAW_F92_DEBUG) BWAPI::Broodwar->drawBoxMap(x-2, y-1, x+75, y+14, BWAPI::Colors::Black, true);
                 //if (Config::Debug::DRAW_F92_DEBUG) BWAPI::Broodwar->drawTextMap(x, y, "\x04 Workers: %d", workersOnMineralPatch[mineral]);
            }
        }
	}
}