...
{
    F92_ASSERT(attacker, "SmartAttackUnit: Attacker not valid");
    F92_ASSERT(target, "SmartAttackUnit: Target not valid");
...
{
    //F92_ASSERT(attacker, "SmartAttackMove: Attacker not valid");
    //F92_ASSERT(targetPosition.isValid(), "SmartAttackMove: targetPosition not valid");
...
{
    F92_ASSERT(unit, "SmartRightClick: Unit not valid");
    F92_ASSERT(target, "SmartRightClick: Target not valid");
...
{
    F92_ASSERT(rangedUnit, "SmartKiteTarget: Unit not valid");
    F92_ASSERT(target, "SmartKiteTarget: Target not valid");
...
{
    F92_ASSERT(muta, "MutaDanceTarget: Muta not valid");
    F92_ASSERT(target, "MutaDanceTarget: Target not valid");
